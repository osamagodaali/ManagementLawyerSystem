...
@section('page-header')
	...
	<div class="breadcrumb-header justify-content-between">
		<div class="my-auto">
			<div class="d-flex">
				<h4 class="content-title mb-0 my-auto">القضايا</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة القضاياالجارية</span>
			</div>
		</div>
	</div>
	<!-- breadcrumb --> 
	<div class="row">
		<div class="col-lg-12 col-md-12">
			...
			<div class="card overflow-hidden">
				<div class="card-body">
					<form action="{{ route('admin.currentcasesfilter') }}" method="POST" autocomplete="off">
						{{ csrf_field() }}
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0"> قائمة القضاياالجارية </h4>
