...
@section('page-header')
	...
	<div class="breadcrumb-header justify-content-between">
		<div class="my-auto">
			<div class="d-flex">
				<h4 class="content-title mb-0 my-auto">القضايا</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة القضايا</span>
			</div>
		</div>
	</div>
	<!-- breadcrumb --> 
	<div class="row">
		<div class="col-lg-12 col-md-12">
			...
			<div class="card overflow-hidden">
				<div class="card-body">
					<form action="{{ route('admin.casesfilter') }}" method="POST" autocomplete="off">
						{{ csrf_field() }}
												...
												<tr>
													...
													<td>
														...
														@elseif($value->case_status == 4)
															<h5  class="text-warning">العمليات </h5>
														@elseif($value->case_status == 5)
															<h5  class="text-dark">التحصيل </h5>
														@endif 
													</td>
													<td>
														...
														@endcan
														@can('انشاء مصروف')
															<a class="btn btn-sm btn-outline-light" data-target="#modalAddExpense{{$value->id }}" data-toggle="modal" href="">اضافة مصروف</a>
														@endcan
														@can('تعديل قضية')
