...
<div class="breadcrumb-header justify-content-between">
	<div class="left-content">
		<div>
			...
			<p class="mg-b-0">لوحة التحكم الرئيسية للعميل</p>
		</div>
	</div>
</div>
<!-- /breadcrumb -->
				...
				{{-- <div class="row">
					<div class="col-lg-12 col-md-12">
						<div class="card" id="solid-alert">
							<div class="card-body">
								<div>
									<h6 class="card-title mb-1">قائمة الاخبار والتنبيهات</h6>
									<p class="text-muted card-sub-title">يجب على الممول اتباع التعليمات الهامة</p>
								</div>
								<div class="text-wrap">
									<div class="example">
										<div class="alert alert-solid-warning" role="alert">
											...
											<strong>تبيه هام</strong> لا يسمح بدخول الممول بدون شهادة التطعيم من فيرس كورونا وارتداء الكمامة !
										</div>
