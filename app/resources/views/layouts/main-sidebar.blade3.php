		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<!-- @endcan -->
					<!-- @if(auth('webadmin')->user()->can('user-list') OR auth('webadmin')->user()->can('user-create')) -->
					<li class="slide">
						...
						<ul class="slide-menu">
							<!-- @can('user-list') -->
								<li><a class="slide-item" href="{{ url('/admin/users' . $page='') }}">قائمة العملاء</a></li>
							<!-- @endcan -->
							<!-- @can('user-create') -->
								<li><a class="slide-item" href="{{ url('/admin/users/create' . $page='') }}">إضافة عميل جديد</a></li>
							<!-- @endcan -->
						</ul>
					</li>
					<!-- @endif -->
					<!-- @if(auth('webadmin')->user()->can('certificates-list') OR auth('webadmin')->user()->can('certificate-create')) -->
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">قائمة القضايا</span><i class="angle fe fe-chevron-down"></i></a>
							<ul class="slide-menu">
								<!-- @can('certificates-list') -->
									<li><a class="slide-item" href="{{ url('admin/certificate' . $page='') }}">قائمة كل القضايا</a></li>
								<!-- @endcan -->
								<!-- @can('certificates-list') -->
									<li><a class="slide-item" href="{{ url('admin/certificate' . $page='') }}">قائمة القضايا الجديدة</a></li>
								<!-- @endcan -->
								<!-- @can('certificates-list') -->
									<li><a class="slide-item" href="{{ url('admin/certificate' . $page='') }}">قائمة القضايا الجارية</a></li>
								<!-- @endcan -->
								<!-- @can('certificates-list') -->
									<li><a class="slide-item" href="{{ url('admin/certificate' . $page='') }}">قائمة القضايا المنتهية</a></li>
								<!-- @endcan -->
								<!-- @can('certificate-create') -->
									<li><a class="slide-item" href="{{ url('admin/certificate/create' . $page='') }}">إضافة قضية جديدة </a></li>
								<!-- @endcan -->
							</ul>
						</li>
					<!-- @endif -->
					<!-- @if(auth('webadmin')->user()->can('dashboard-revenue_investors') OR auth('webadmin')->user()->can('dashboard-expenses_investors')) -->
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M3.31 11l2.2 8.01L18.5 19l2.2-8H3.31zM12 17c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" opacity=".3"/><path d="M22 9h-4.79l-4.38-6.56c-.19-.28-.51-.42-.83-.42s-.64.14-.83.43L6.79 9H2c-.55 0-1 .45-1 1 0 .09.01.18.04.27l2.54 9.27c.23.84 1 1.46 1.92 1.46h13c.92 0 1.69-.62 1.93-1.46l2.54-9.27L23 10c0-.55-.45-1-1-1zM12 4.8L14.8 9H9.2L12 4.8zM18.5 19l-12.99.01L3.31 11H20.7l-2.2 8zM12 13c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/></svg><span class="side-menu__label">الحسابات</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<!-- @can('dashboard-revenue_investors') -->
								<li><a class="slide-item" href="{{ url('/' . $page='admin/revenue_investors') }}">تقرير الايرادات </a></li>
							<!-- @endcan -->
							<!-- @can('dashboard-revenue_investors') -->
								<li><a class="slide-item" href="{{ url('/' . $page='admin/revenue_investors') }}">اضافة عملية ايداع </a></li>
							<!-- @endcan -->
							<!-- @can('dashboard-expenses_investors') -->
								<li><a class="slide-item" href="{{ url('/' . $page='admin/expenses_investors') }}">تقرير المصروفات </a></li>
							<!-- @endcan -->
							<!-- @can('dashboard-revenue_investors') -->
								<li><a class="slide-item" href="{{ url('/' . $page='admin/revenue_investors') }}">اضافة عملية مصروف </a></li>
							<!-- @endcan -->
						</ul>
					</li>
					<!-- @endif -->
					<!-- @if(auth('webadmin')->user()->can('order-index') 
						OR auth('webadmin')->user()->can('order-approved_orders') 
						OR auth('webadmin')->user()->can('order-waiting_orders')
						OR auth('webadmin')->user()->can('order-waiting_fees_orders')
						OR auth('webadmin')->user()->can('order-finished_orders')
						OR auth('webadmin')->user()->can('order-rejected_orders')
						OR auth('webadmin')->user()->can('order-archived_orders')
					) -->
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M3.31 11l2.2 8.01L18.5 19l2.2-8H3.31zM12 17c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" opacity=".3"/><path d="M22 9h-4.79l-4.38-6.56c-.19-.28-.51-.42-.83-.42s-.64.14-.83.43L6.79 9H2c-.55 0-1 .45-1 1 0 .09.01.18.04.27l2.54 9.27c.23.84 1 1.46 1.92 1.46h13c.92 0 1.69-.62 1.93-1.46l2.54-9.27L23 10c0-.55-.45-1-1-1zM12 4.8L14.8 9H9.2L12 4.8zM18.5 19l-12.99.01L3.31 11H20.7l-2.2 8zM12 13c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/></svg><span class="side-menu__label">الطلبات</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<!-- @can('order-index') -->
								<li><a class="slide-item" href="{{ url('/' . $page='admin/order') }}">قائمة الطلبات الجديدة</a></li>
							<!-- @endcan -->
							<!-- @can('order-approved_orders') -->
								<li><a class="slide-item" href="{{ url('/' . $page='admin/approved_orders') }}">قائمة الطلبات المقبولة</a></li>
							<!-- @endcan -->
							<!-- @can('order-waiting_orders') -->
								<li><a class="slide-item" href="{{ url('/' . $page='admin/waiting_orders') }}">قائمة الطلبات تحت المراجعة</a></li>
							<!-- @endcan -->
							<!-- @can('order-waiting_fees_orders') -->
								<li><a class="slide-item" href="{{ url('/' . $page='admin/waiting_fees_orders') }}">قائمة الطلبات بانتظار تحديد الرسوم </a></li>
							<!-- @endcan -->
							<!-- @can('order-finished_orders') -->
								<li><a class="slide-item" href="{{ url('/' . $page='admin/finished_orders') }}">قائمة الطلبات المنتهية</a></li>
							<!-- @endcan -->
							<!-- @can('order-rejected_orders') -->
								<li><a class="slide-item" href="{{ url('/' . $page='admin/rejected_orders') }}">قائمة الطلبات المرفوضة</a></li>
							<!-- @endcan -->
							<!-- @can('order-archived_orders') -->
								<li><a class="slide-item" href="{{ url('/' . $page='admin/archived_orders') }}">قائمة الطلبات المؤرشفة</a></li>
							<!-- @endcan -->
						</ul>
					</li>
					<!-- @endif -->
					
					<!-- @if(auth('webadmin')->user()->can('employees-list') OR auth('webadmin')->user()->can('employee-create')) -->
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">الموظفين</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<!-- @can('employees-list') -->
								<li><a class="slide-item" href="{{ url('/' . $page='admin/employees') }}">قائمة الموظفين</a></li>
							<!-- @endcan -->
							<!-- @can('employee-create') -->
								<li><a class="slide-item" href="{{ url('/' . $page='admin/employees/create') }}">إضافة موظف جديد</a></li>
							<!-- @endcan -->
						</ul>
					</li>
					<!-- @endif -->
					<!-- @if(auth('webadmin')->user()->can('role-list') OR auth('webadmin')->user()->can('permission-list')) -->
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">الادوار والصلاحيات</span><i class="angle fe fe-chevron-down"></i></a>
							<ul class="slide-menu">
								<!-- @can('role-list') -->
									<li><a class="slide-item" href="{{ url('/' . $page='admin/roles') }}">قائمة الادوار</a></li>
								<!-- @endcan -->
								<!-- @can('permission-list') -->
									<li><a class="slide-item" href="{{ url('/' . $page='admin/permissions') }}">قائمة الصلاحيات  </a></li>
								<!-- @endcan -->
							</ul>
						</li>
					<!-- @endif -->
					<!-- @if(auth('webadmin')->user()->can('role-list') OR auth('webadmin')->user()->can('permission-list')) -->
						<li class="slide">
							...
							<ul class="slide-menu">
								<!-- @can('role-list') -->
									<li><a class="slide-item" href="{{ url('/' . $page='admin/roles') }}">قالاعدادات العامةائمة </a></li>
								<!-- @endcan -->
								<!-- @can('permission-list') -->
									<li><a class="slide-item" href="{{ url('/' . $page='admin/permissions') }}">قائمة الفروع </a></li>
								<!-- @endcan -->
							</ul>
						</li>
					<!-- @endif -->
					<li class="slide">
						<a class="side-menu__item" href="{{ route('logout') }}"
										onclick="event.preventDefault();document.getElementById('logout-form').submit();"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon"  viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h4v4H5zm10 10h4v4h-4zM5 15h4v4H5zM16.66 4.52l-2.83 2.82 2.83 2.83 2.83-2.83z" opacity=".3"/><path d="M16.66 1.69L11 7.34 16.66 13l5.66-5.66-5.66-5.65zm-2.83 5.65l2.83-2.83 2.83 2.83-2.83 2.83-2.83-2.83zM3 3v8h8V3H3zm6 6H5V5h4v4zM3 21h8v-8H3v8zm2-6h4v4H5v-4zm8-2v8h8v-8h-8zm6 6h-4v-4h4v4z"/></svg><span class="side-menu__label">تسجيل خروج  </span>
									</a>
